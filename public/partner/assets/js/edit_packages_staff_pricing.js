"use strict";
var KTAppEcommerceEditPackagesService = (function () {
    const e = () => {
            $("#kt_ecommerce_edit_packages_conditions").repeater({
                initEmpty: !1,
            ...
            ["#kt_ecommerce_add_category_description", "#kt_ecommerce_add_category_meta_description"].forEach((e) => {
                ...
                (() => {
                    ...
                    (e = FormValidation.formValidation(t, {
                        fields: { category_name: { validators: { notEmpty: { message: "Category name is required" } } } },
...
KTUtil.onDOMContentLoaded(function () {
    KTAppEcommerceEditPackagesService.init();
});
