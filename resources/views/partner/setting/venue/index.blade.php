                        ...
                        <div class="d-flex-flex-column">
                           <div class="d-flex flex-column scroll-y me-n7 pe-7">
                              ...
                              <div class="fv-row mb-7">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" id="business_location" name="business_location" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="business locationn" id="edit_venue_business_location" required/>
                                 <!--end::Input-->
                              </div>
                              <!--end::Input group-->
                           </div>
			...
			$.ajax({
				...
				success:function(response)
				{
					...
					if (response.status) {
						...
						$("#business_location").val(venues_meta.business_location);
						...
						/*if (status == "1"){
							...
							$('#edit-status').find(':checkbox[name=status][value="1"]').prop('checked', true);

						}else{

							$('#edit-status').find(':checkbox[name=status][value="0"]').prop('checked', true);
