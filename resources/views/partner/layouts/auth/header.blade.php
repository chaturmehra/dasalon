...
<html lang="en">
	...
	<head><base href=""/>
		...
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700" />
		<link href="{{asset('/public/assets/plugins/custom/fullcalendar/fullcalendar.bundle')}}" rel="stylesheet" type="text/css" />
		<link href="{{asset('/public/assets/plugins/custom/datatables/datatables.bundle')}}" rel="stylesheet" type="text/css" />
		<link href="{{asset('/public/assets/css/assets/plugins/global/plugins.bundle.css')}}" rel="stylesheet" type="text/css" />
