   ...
   <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <!--begin::Close-->
            <div class="btn btn-icon btn-sm btn-active-light-primary ms-2 close_form" data-bs-toggle="modal" data-bs-target="#kt_modal_update_scrollable22" data-bs-dismiss="modal" aria-label="Close">
