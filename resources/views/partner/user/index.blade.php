				...
				<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						...
						<div class="row g-3">
							...
							<div class="col-md-12">
								<!--begin::Google link=-->
								<a href="{{route('signup-service-provided')}}" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100 py-5">
							...
							<div class="col-md-12">
								<!--begin::Google link=-->
								<a href="{{ route('book-a-service' )}}" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100 py-5">
