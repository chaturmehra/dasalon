  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="fw-bold text-dark">Add Service(At Home)</h1>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="fv-row">
                      ...
                      <div class="d-flex flex-wrap gap-5">
                        ...
                        <div class="fv-row w-100 flex-md-root">
                          <!--begin::Input-->
                          <input type="text" class="form-control mb-2" placeholder="Distance" name="distance" onchange="numberHandler(this)">
                          <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                      </div>
              ...
              <div class="card-body pt-0">
                ...
                <div class="fv-row">
                  ...
                  <div  data-kt-ecommerce-catalog-add-category="auto-options">
                    <!--begin::Repeater-->
                    <div id="kt_ecommerce_add_home_service_conditions">
                      <!--begin::Form group-->
                      <div class="form-group">
                        <div data-repeater-list="kt_ecommerce_add_home_service_conditions" class="d-flex flex-column gap-0">
