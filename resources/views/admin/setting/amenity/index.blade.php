                                                ...
                                                <form class="form" name='amenity-form' enctype="multipart/form-data">
                                                   ...
                                                   <div class="d-flex flex-column scroll-y me-n7 pe-7">
                                                      ...
                                                      <div class="fv-row mb-7">
                                                         ...
                                                         <!--end::Label-->
                                                         <!--begin::Input-->
                                                         <!-- <input type="text" id="amenity_category" name="amenity_category" class="form-control mb-3 mb-lg-0" placeholder="Amenity Category"/> -->

                                                         <select id="amenity_categories" name="amenity_category" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select a Amenity Category...">
                                                         	<
                                                         	@foreach(adminAmenityCategories() as $amenity_val)
                                                         	<option value="{{$amenity_val}}">{{$amenity_val}}</option>
                                                         	@endforeach
...
<script type="text/javascript">
   ...
   submitHandler: function(form) {
     ...
     var amenity_category = $('#amenity_categories').val();
   ...
   var input_add_service = document.querySelector("#amenity_category");
