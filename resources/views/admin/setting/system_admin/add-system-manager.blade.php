		...
		<div id="kt_app_content" class="app-content flex-column-fluid">
			...
			<div id="kt_app_content_container" class="app-container container-fluid">
				...
				<div class="card card-flush">
					...
					<!--begin::Form-->
					<form class="form mb-6" action="{{ url('/admin/add-system-manager') }}" method="post">
						@csrf
						...
						<div class="card-body pt-10 pb-0">
							...
							<h1 class="fw-bold text-dark mb-9">Add System Manager</h1>
							<!--begin::Input group-->
							<div class="row mb-5">
								...
								<div class="col-md-6 fv-row mb-7">
									...
									<!--end::Label-->
									<!--end::Input-->
									<input type="text" class="form-control form-control-solid" placeholder="Phone" name="phone" value="{{ old('phone') }}"/>
									<!--end::Input-->
								</div>
								<!--end::Col-->
