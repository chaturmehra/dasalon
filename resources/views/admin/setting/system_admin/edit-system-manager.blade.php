				...
				<div class="card-body pt-0">
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5">
						...
						@endphp 
							...
							@foreach($usersysmanagerperm as  $propvalue )
							
						<tr>
								<td>{{++$count}}</td>
								<td>
								<input type="hidden" name="page[]" value="{{$propvalue->page}}" />
									{{$propvalue->page}}
								</td>
								<td>
								<input type="hidden" name="subpage[]" value="{{$propvalue->subpage}}" />
								{{ $propvalue->subpage }}
								</td>
								<td>
									<div class="form-check form-switch form-check-custom form-check-solid">
										...
										value="1"
										@if($propvalue->property_value && $manager_detail->id == $propvalue->user_id) checked={{ "checked" }} @endif
										name="property_value[{{$propvalue->page}}][{{$propvalue->subpage}}]"
										type="checkbox" value="" id="flexSwitchDefault"/>
